...
A new job copies the published checklist from each service at create time. If a service has no published checklist, the job shows **No checklist has been added to this job.**

Complete items on the job detail page. Customers do not see the checklist. Required photo or video steps must be finished before you can mark the job complete. Optional steps never block completion.
