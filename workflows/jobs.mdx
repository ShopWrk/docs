...
Check off items there as work gets done. Customers do not see the checklist. Required photo or video steps must be finished before you can mark the job complete. Optional steps never block completion.
