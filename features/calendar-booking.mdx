...
<Steps>
  ...
  <Step title="Convert to a job">
    When you're ready to confirm, convert the request to a job. ShopWrk creates the job and links it to the contact — no double entry needed. If your booking page collects deposits, the request can require payment before it ever reaches your queue; abandoned checkouts expire automatically instead of clogging the list.
  </Step>
</Steps>
