...
The inventory page is organized into four tabs: **Overview**, **Stock**, **Catalog**, and **Reports**.
...
When a job runs a service that carries an allocation, ShopWrk knows what the job should consume before anyone touches a roll. That turns usage reports from estimates into records: consumption posts against the job, waste gets logged separately, and cost-per-job reflects reality.
