...
sidebarTitle: "CRM"
icon: "contact"
description: "Manage your entire sales pipeline, customer profiles, vehicle history, and deal tracking from a board with columns built for auto styling shops."
---
...
The CRM pipeline is a board with columns, where each column is a stage in your sales process. Navigate to **CRM** in the sidebar to open it.
