...
If you run Lead Ads on Facebook or Instagram, connect Meta first (see [Connect Facebook and Instagram](/integrations/meta)), then open **Marketing → Forms** and import the lead form. Map each Meta question to a ShopWrk contact field once; after that, submissions flow in automatically with the mapping applied.
...
<CardGroup cols={2}>
  ...
  <Card title="Meta connections" icon="share-nodes" href="/integrations/meta">
    Bring Facebook Lead Ads into the same inbox.
  </Card>
</CardGroup>