...
If a shop owner sent you an invitation, your signup flow is different from the one above. Open the link in your invitation email — it takes you to a join page where your email address is pre-filled and If someone invited you to a shop, open the link in that email. ShopWrk takes you to a join page with your email already filled in. Finish setting up your account and verify your email to join the shop.
