...
Some shops keep labor and material costs private from front-desk staff. Owners can scope price visibility by role under team permissions: a member can run their whole workflow with prices hidden or shown only as totals, while owners see full margins. Redaction applies everywhere the number would appear, including lists, documents, and exports.
