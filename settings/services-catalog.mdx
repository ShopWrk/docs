...
Click **Create blank** or **Use template** to add a checklist. A draft stays on the service until you publish it. New jobs only copy a published checklist.

The old checklist tab on the service is gone. Full steps are in [Create service checklists and complete them on jobs](/settings/checklists).
