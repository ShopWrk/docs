...
<Steps>
  ...
  <Step title="Choose a category">
    Categories organize your catalog. A modifier can be limited to a category, and you choose which applicable modifiers to assign to each service.
  </Step>
...
In **Settings → Services**, set the default price and duration multipliers used when you create new services. In each service editor, review the variants-by-vehicle-group pricing grid and enter customer-facing prices. Changing a default never rewrites existing estimates or invoices.
...
Go to **Settings → Payments** to set the tax mode for your shop:
