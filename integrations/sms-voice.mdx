...
1. Submitting your business brand.
2. Completing carrier vetting.
3. Registering your messaging campaign.
4. Assigning an approved phone number.
...
ShopWrk handles carrier keywords automatically. STOP, UNSUBSCRIBE, CANCEL, END, and QUIT opt a customer out. START, YES, UNSTOP, and SUBSCRIBE opt them back in. HELP and INFO return your shop information and opt-out instructions. Messages to an opted-out number are blocked at the platform level.

Marketing texts also require explicit marketing consent; a customer who booked work hasn't necessarily agreed to receive promotions.
