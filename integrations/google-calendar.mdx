...
If failed events appear, click **Retry Failed Events** to try the sync again. If failures persist, disconnect and reconnect your Google Calendar to refresh the authorization token.
